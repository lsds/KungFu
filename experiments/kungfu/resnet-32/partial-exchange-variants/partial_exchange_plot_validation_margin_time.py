...
from plot_replicated_time import *
...
def plot_ako(current_partition, current_partition_index, data_ako, partitions, peers, epochs):
    # data_ako   : tuple (parts, peer, time, epoch, top1, top5)
...
def plot_validation_accuracy(current_partition, current_partition_index, data_ako, partitions, peers, epochs):
    ...
    # plt.title('ResNet-32 Average Top 1 Peer Validation Accuracy over Physical Time with Bin Packing Partial Gradient Exchange and Running Average over Gradient History')
    plt.title('ResNet-32 Average Top 1 Peer Validation Accuracy over Physical Time with Bin Packing Partial Gradient Exchange and All-Reduce Average over Peer Count')



    plt.xticks(np.arange(1, 1700, 100))
