...
{
REGISTER_OP("PartialAccumulatingNegotiatorGpu")
...
class PartialAccumulatingNegotiatorGpu : public AsyncOpKernel
{
  ...
  public:
    ...
    explicit PartialAccumulatingNegotiatorGpu(OpKernelConstruction *context)
...
REGISTER_KERNEL_BUILDER(
    Name("PartialAccumulatingNegotiatorGpu").Device(DEVICE_GPU),
    PartialAccumulatingNegotiatorGpu);
