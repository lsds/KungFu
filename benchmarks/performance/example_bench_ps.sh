...
# ps0
echo "launch ps 0"
CUDA_VISIBLE_DEVICES=-1 python benchmark_ps.py --ps_hosts=$PS_HOSTS --worker_hosts=$WORKER_HOSTS --job_name=ps --task_index=0 &

# ps1
echo "launch ps 1"
CUDA_VISIBLE_DEVICES=-1 python benchmark_ps.py --ps_hosts=$PS_HOSTS --worker_hosts=$WORKER_HOSTS --job_name=ps --task_index=1 &

# ps2
echo "launch ps 2"
CUDA_VISIBLE_DEVICES=-1 python benchmark_ps.py --ps_hosts=$PS_HOSTS --worker_hosts=$WORKER_HOSTS --job_name=ps --task_index=2 &

# ps3
echo "launch ps 3"
CUDA_VISIBLE_DEVICES=-1 python benchmark_ps.py --ps_hosts=$PS_HOSTS --worker_hosts=$WORKER_HOSTS --job_name=ps --task_index=3 &
