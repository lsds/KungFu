...
RUN_EXPERIMENTS_SCRIPT = FILE_PATH + "/scripts/azure/relay-machine/run-experiments.sh"
EXPERIMENT_SCRIPT     = "./examples/lenet.py"
...
config_grid = {'strategy': ['ako', 'plain'], 
               ...
               'parts'   : [2, 4, 8], # Number of partitions
               }

run_experiments(n_epochs=3)