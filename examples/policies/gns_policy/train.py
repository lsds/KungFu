...
def parse_args():
    ...
    p.add_argument('--epoch-size', type=int, default=1024, help='')
    p.add_argument('--epoch-num', type=int, default=1, help='')
    p.add_argument('--max-train-steps', type=int, default=100, help='')
